            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <b>
                    <a href="/houseandland"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <b>
                    <a href="/hotel"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold text-yellow-400 text-left">3D Animation Academy</h6>
                  <p class="mt-2 mb-4 text-gray-600 line-clamp-3">
                    We offer to our new students opportunity to learn 3D animation. Are you interested to venture into the world of animation,
                    we are here to offer you a comprehensive training and job opportunity after this learning adventure.
                  </p>
                  <b>
                    <a href="/animation"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <b>
                    <a href="/web"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <b>
                    <a href="/caregiving"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
              ...
              >
                <div class="px-4 py-5 flex-auto ">
                  ...
                  <p class="mt-2 mb-4 text-black line-clamp-3">
                   ...
                   <b>
                    <a href="/cleaning"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <p class="mt-2 mb-4 text-gray-600 line-clamp-3">
                   ...
                   <b>
                    <a href="/ogtv"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <b>
                    <a href="/nanny"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto ">
                  ...
                  <b>
                    <a href="/building"> <span class="text-blue-700">more...</span></a></b>
                </div>
              </div>
            </div>
          </div>
